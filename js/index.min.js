...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let count = setInterval(function() {
        ...
        let list = document.getElementById('llist')
        let likes = document.querySelector('.likes')
        let input = doucment.getElementById('comment-input')
        ...
        heart.addEventListener("click", function(e) {
            let obj = doucment.getElementById(`${counter.innerText}`);
            obj ? obj.children[0].innerText++ : likes.innerHTML += `<li id=${counter.innerText}>${counter.innerText} has been liked <span id=${counter.innerText}>1</span> times.</li>`});
